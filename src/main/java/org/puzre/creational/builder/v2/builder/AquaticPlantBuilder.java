...
public class AquaticPlantBuilder implements PlantBuilder{
    ...
    public AquaticPlant getProduct() {
        return new AquaticPlant(this.name, this.root, this.stem, this.leaf, this.waterSource, this.habitat);
    }
